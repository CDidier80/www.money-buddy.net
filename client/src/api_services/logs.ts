...
export const ServiceLoggers: LoggerTypes = {
    ...
    UserApiErrorLog : (serviceFunction, error) => {
        console.log(`TRY{}CATCH{} ERROR --> FILE: UserApi.js -->  FUNCTION: ${serviceFunction.name} --> MESSAGE: `, error)
    },
    ...
    IncomeApiLog : (serviceFunction, body, params) => {
        console.log(`Request arrived in IncomeApi.ts => function: ${serviceFunction.name} => carrying body: `, body,  " and params: ", params)
    },

    IncomeApiErrorLog : (serviceFunction, error) => {
        console.log(`TRY{}CATCH{} ERROR --> FILE: IncomeApi.ts -->  FUNCTION: ${serviceFunction.name} --> MESSAGE: `, error)
    },
    ...
    ExpenseApiLog : (serviceFunction, body, params) => {
        console.log(`Request arrived in ExpenseApi.js => function: ${serviceFunction.name} => carrying body: `, body,  " and params: ", params)
    },
    
    ExpenseApiErrorLog : (serviceFunction, error) => {
        console.log(`TRY{}CATCH{} ERROR --> FILE: ExpenseApi.js -->  FUNCTION: ${serviceFunction.name} --> MESSAGE: `, error)
    },

    CashflowApiLog : (serviceFunction, body, params) => {
        console.log(`Request arrived in CashflowApi.js => function: ${serviceFunction.name} => carrying body: `, body,  " and params: ", params)
    },

    CashflowApiErrorLog : (serviceFunction, error) => {
        console.log(`TRY{}CATCH{} ERROR --> FILE: CashflowApi.js -->  FUNCTION: ${serviceFunction.name} --> MESSAGE: `, error)
    },
}
